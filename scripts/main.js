;(function (window) {
  ...
  let texts = ['HAII GHEFIRA', 'LIAT BINTANG" INI?', 'BINTANG" INI', 'SHINE FOR YOU', 'YOU AS BAUTIFUL', 'AS THOSE STARS', 'FR HAHAHA', 'APALAGI YA YG MAU BT BILANG', 'AHH 1 THING', 'KALO LAGI DOWN', 'LIAT SAJA BINTANG', 'DI LANGIT', 'SAMUA BERSINAR PAR OSE', 'SO...', 'STAY STRONG LITTLE BEE', 'EAT, SLEEP PROPERLY', 'LOVE YOU🤍']
  ...
  function draw() {
    ...
    // Perbarui posisi teks agar berada di tengah canvas
